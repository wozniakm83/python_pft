    ...
    def get_contact_list(self):
        ...
        try:
            cursor.execute("select id, firstname, lastname, address, email, email2, email3, "
                           "home, mobile, work, phone2, homepage from addressbook where deprecated = '0000-00-00'")
            for row in cursor:
                (id, firstname, lastname, address, email, email2, email3, home, mobile, work, phone2, homepage) = row
